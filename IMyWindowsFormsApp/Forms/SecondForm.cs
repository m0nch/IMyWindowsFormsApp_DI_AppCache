    ...
    public partial class SecondForm : Form
    {
        ...
        private void grdStudents_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                var objName = ((DataGridView)sender).SelectedRows[0].Cells["stFullName"].Value;
        ...
        private void RefreshStudents()
        {
            ...
            grdStudents.DataSource = _studentService.GetAllByTeacher((Guid)_appCache._ViewBag["TeacherId"]).MapStudentsToViewModel();
